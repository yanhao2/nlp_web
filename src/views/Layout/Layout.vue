...
<style lang="scss">
    ...
    .el-tabs__item.is-active, .el-tabs__item:hover, .ivu-select-item-selected, .ivu-select-item-selected:hover{
        color: #12d4c9;
    }
    .el-tabs__active-bar{
        background-color: #12d4c9;
    }
    .ivu-select-visible .ivu-select-selection, .ivu-input:hover, .ivu-input:hover, .ivu-select-selection-focused, .ivu-select-selection:hover{
        border-color: #12d4c9;
    }
</style>
