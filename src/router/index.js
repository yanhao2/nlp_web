...
routes = [
    {
        path: '/',
        name: 'Headers',
        component: () => import(/* webpackChunkName: "about" */ '../components/Headers.vue'),
        children: [
            {
                path: '/',
                name: 'Layout',
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        name: '对象层面情感',
                        component: () => import(/* webpackChunkName: "about" */ '../views/ObjectLevelEmotion.vue'),
                    },
...

            {
                path: '/aIRecognition',
                name: 'AI图像识别',
                component: () => import(/* webpackChunkName: "about" */ '../views/AIRecognition.vue'),
            },
        ]
    },
    {
        path: '/index',
        name: 'indexs',
        component: () => import(/* webpackChunkName: "about" */ '../views/Children/Headers.vue'),
        children: [
            {
                path: '/index/objectLevelEmotion',
                name: '对象层面情感',
                component: () => import(/* webpackChunkName: "about" */ '../views/Children/ObjectLevelEmotion.vue'),
            },
            {
